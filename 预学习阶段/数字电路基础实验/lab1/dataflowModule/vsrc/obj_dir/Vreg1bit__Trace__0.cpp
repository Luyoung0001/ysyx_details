...
void Vreg1bit___024root__trace_chg_sub_0(Vreg1bit___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vreg1bit___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreg1bit___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vreg1bit___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vreg1bit___024root__trace_chg_sub_0(Vreg1bit___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vreg1bit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreg1bit___024root__trace_chg_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    bufp->chgBit(oldp+0,(vlSelf->rst_n));
    bufp->chgBit(oldp+1,(vlSelf->d));
    bufp->chgBit(oldp+2,(vlSelf->q));
}

void Vreg1bit___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreg1bit___024root__trace_cleanup\n"); );
    // Init
    Vreg1bit___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vreg1bit___024root*>(voidSelf);
    Vreg1bit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
